...
arch=$(uname -m)
if [ "$arch" == "armv7l" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://github.com/mbfoo/wallbox-mqtt-bridge-evcc/releases/latest/download/bridge-armhf
elif [ "$arch" == "aarch64" ]; then
    curl -sSfL --create-dirs -o ~/mqtt-bridge/bridge https://github.com/mbfoo/wallbox-mqtt-bridge-evcc/releases/latest/download/bridge-arm64
else
